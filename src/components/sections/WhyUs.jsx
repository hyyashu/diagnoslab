    ...
    <div className="flex flex-col text-center my-10 p-4 bg-gradient-to-r">
      ...
      <div className="flex flex-wrap md:flex-nowrap justify-center gap-10 p-4">
        {[
          ...
          <div
            key={index}
            className="w-full sm:w-1/2 md:w-1/4 text-pretty flex flex-col items-center text-black"
          >
            <i className={`text-primary fa-2x md:fa-3x ${item.icon} mb-2`}></i>
