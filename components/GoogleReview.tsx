...
function GoogleReviews() {
    ...
    useEffect(() => {
        if (isLoaded && !loadError) {
            ...
            service.getDetails({placeId: "ChIJK7tAjwjj9TkRc6IthQcJGEY", fields: ["reviews"],}, (place, status) => {
    ...
    return (
        <div className="p-4 max-w-screen-xl mx-auto">
            <div className="flex justify-between items-center mb-4">
                ...
                <button className="bg-blue-500 text-white px-4 py-2 rounded">Review us on Google</button>
            </div>
